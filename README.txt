...
Description:
Pizza\_project est une application de gestion de pizzeria permettant de gérer les clients, les commandes, les pizzas, les ingrédients, et bien plus encore. Elle propose une interface utilisateur intuitive pour les employés et les clients.
