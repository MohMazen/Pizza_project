...
/**
 * Représente un livreur de pizzas, avec son identité, son véhicule
 * et les commandes qu’il doit livrer depuis un point Pizzaria.
 */
public class Livreur {
	private int id_liv;
	private String nom_L;
	private String type_Vec;                  // "voiture" ou "moto"
