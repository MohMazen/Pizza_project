...
public class Point_Pizzaria {
	...
	public int consommerIngredients(Pizza pizza, int qty) {
		// Vérification préalable des disponibilités
	...
	public int creerCommande(Client client, String nomPizza, String taille, int qty, String typeVehicule) {
		...
		switch (taille.toLowerCase()) {
			case "naine":   prixUnitaire = base * 2.0 / 3.0; break;
			case "ogresse": prixUnitaire = base * 4.0 / 3.0; break;
	...
	/**
	 * Affiche l’état des commandes d’un client, avec temps restant ou retard.
	 */
