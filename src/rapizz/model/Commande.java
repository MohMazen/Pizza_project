...
public class Commande {
	// Limite de pizzas pour bénéficier d'une réduction
	...
	/**
	 * Valide la commande en débité le compte client.
	 * @param pizzaria point de vente (inutile ici)
	 * @return 1 si validée (et débitée), 0 sinon.
	 */
